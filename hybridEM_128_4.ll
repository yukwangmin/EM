...
-args " --procNumX=8 --procNumY=4 --procNumZ=4 --start_time=0 --end_time=0.00000001 --dt=0.000000000001 --left_x=0 --right_x=0.256 --dx=0.001 --left_y=0 --right_y=0.256 --dy=0.001 --left_z=0 --right_z=0.256 --dz=0.001 --vis_interval=2"
#
