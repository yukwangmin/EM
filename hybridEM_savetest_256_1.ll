...
# @ class = normal
#
# @ job_name = hybridEM_savetest_256_1
#
...
-cwd $(initialdir) \
-mode VN \
-args " --procNumX=8 --procNumY=8 --procNumZ=4 --start_time=0 --end_time=0.000000001 --dt=0.000000000001 --left_x=0 --right_x=0.256 --dx=0.004 --left_y=0 --right_y=0.256 --dy=0.004 --left_z=0 --right_z=0.256 --dz=0.004 --vis_interval=50"
#
