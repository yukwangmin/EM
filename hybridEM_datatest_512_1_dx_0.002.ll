...
# @ class = normal
#
# @ job_name = hybridEM_datatest_512_1_dx_0.002
#
...
-cwd $(initialdir) \
-mode VN \
-args " --procNumX=8 --procNumY=8 --procNumZ=8 --start_time=0 --end_time=0.00000000001 --dt=0.000000000001 --left_x=0 --right_x=0.256 --dx=0.002 --left_y=0 --right_y=0.256 --dy=0.002 --left_z=0 --right_z=0.256 --dz=0.002"
#
